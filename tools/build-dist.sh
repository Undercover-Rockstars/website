...
for d in assets .well-known collection thesis fitting-room bag product; do
  cp -R "$d" "dist/$d"
done
...
for f in ur.css ur-data.js ur-common.js ur-collection.js ur-product.js ur-signal.js ur-bag.js ur-fitting.js; do
